...
$(document).ready(function () {
    ...
    const style = `
        ...
        #formTitle { background-color:#dc3545; color:#fff; padding:12px 0; margin:-15px -15px 20px -15px; text-align:center; font-size:20px; font-weight:600; border-radius:10px 10px 0 0; }
